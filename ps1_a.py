...
next_arrival_time = time_ + random.expovariate(10)
server_status = "idle"
queue = 0
arrived_customers += 1
...
print(customer_df)
print(arrived_customers)
print(departed_customers)
print(customer_df['time in queue'])
plt.plot(customer_df['customer'],customer_df['time in queue'])
plt.ylabel('Time in queue(sec)')
plt.xlabel('Customer number')
plt.show()
print(sum(customer_df['time in queue'])/len(customer_df['customer']))